    ...
    implements UserPermissionManagementOperator
{
    ...
    public async createUserPermission(
        ...
        if (createUserPermissionError !== null) {
            this.logger.error(
                "failed to call user_service.createUserPermission()",
                { error: createUserPermissionError }
            );
        ...
        return UserPermission.fromProto(
            createUserPermissionResponse?.userPermission
        );
    }
    ...
    public async getUserPermissionList(): Promise<UserPermission[]> {
        const {
            ...
            response: getUserPermissionListResponse,
        } = await promisifyGRPCCall(
        ...
        if (getUserPermissionListError !== null) {
            this.logger.error(
                "failed to call user_service.getUserPermissionList()",
                { error: getUserPermissionListError }
            );
            throw new ErrorWithHTTPCode(
        ...
        return (
            getUserPermissionListResponse?.userPermissionList?.map(
                (userPermissionProto) =>
    ...
    public async updateUserPermission(
        ...
        const {
            ...
            response: updateUserPermissionResponse,
        } = await promisifyGRPCCall(
        ...
        if (updateUserPermissionError !== null) {
            this.logger.error(
                "failed to call user_service.updateUserPermission()",
                { error: updateUserPermissionError }
            );
            throw new ErrorWithHTTPCode(
        ...
        return UserPermission.fromProto(
            updateUserPermissionResponse?.userPermission
        );
    }
    ...
    public async deleteUserPermission(id: number): Promise<void> {
        ...
        if (updateUserPermissionError !== null) {
            this.logger.error(
                "failed to call user_service.deleteUserPermission()",
                { error: updateUserPermissionError }
            );
            throw new ErrorWithHTTPCode(
    ...
    public async addUserPermissionToUserRole(
        ...
        if (addUserPermissionToUserRoleError !== null) {
            this.logger.error(
                "failed to call user_service.addUserPermissionToUserRole()",
    ...
    public async removeUserPermissionFromUserRole(
        ...
        if (removeUserPermissionFromUserRoleError !== null) {
            this.logger.error(
                "failed to call user_service.removeUserPermissionFromUserRole()",
                { error: removeUserPermissionFromUserRoleError }
            );
            throw new ErrorWithHTTPCode(
                "failed to remove user permission from user role",
                getHttpCodeFromGRPCStatus(
                    removeUserPermissionFromUserRoleError.code
                )
            );
        }
    }
