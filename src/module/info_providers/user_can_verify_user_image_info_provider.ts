...
export class UserCanVerifyUserImageInfoProviderImpl
    implements UserCanVerifyUserImageInfoProvider
{
    constructor(
...
export const USER_CAN_VERIFY_USER_IMAGE_INFO_PROVIDER_TOKEN =
    token<UserCanVerifyUserImageInfoProvider>(
