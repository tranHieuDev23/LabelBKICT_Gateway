...
export class UserCanManageUserImageInfoProviderImpl
    implements UserCanManageUserImageInfoProvider
{
    constructor(
...
export const USER_CAN_MANAGE_USER_IMAGE_INFO_PROVIDER_TOKEN =
    token<UserCanManageUserImageInfoProvider>(
