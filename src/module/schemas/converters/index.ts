...
import {
    ...
    PointOfInterestProtoToPointOfInterestConverterImpl,
} from "./point_of_interest_proto_to_point_of_interest";
...
export * from "./point_of_interest_proto_to_point_of_interest";
...
export function bindToContainer(container: Container): void {
    ...
    container
        ...
        .inSingletonScope();
    container
        .bind(POINT_OF_INTEREST_PROTO_TO_POINT_OF_INTEREST_CONVERTER_TOKEN)
        .toInstance(PointOfInterestProtoToPointOfInterestConverterImpl)
        .inSingletonScope();
}
